...
#start_date_range = (datetime.now() - timedelta(days=1)).replace(day=1)
#end_date_range = datetime.now() - timedelta(days=1)
start_date_range = datetime(2022, 1,1)  # Fecha inicial
end_date_range = datetime(2025, 6, 30)    # Fecha final
        ...
        try:
            ...
            if response:
                ...
                for cost_detail in root.findall('.//DetalleCostos'):
                    ...
                    cursor.execute("""
                        SELECT id,CostoTotal FROM costeoMensual
                    ...
                    if row: # Si existe el registro
                        ...
                        print(f"El costo descargado es: {total_costo} y el de la bd es {total_db}")
